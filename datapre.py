...
def make_ind(n):
    ...
    torch.save(ind, '/mnt/share1/pengxingwen/reconstruction_pxw/src/data/ind_4_3.pt')
    return ind
...
def make_cnd():
    ...
    # plt.colorbar()
    # plt.savefig('cnd_c1.png',bbox_inches='tight', pad_inches=0.3)
    torch.save(cnd, './cnd_c3.pt')
# cnd = torch.load('./cnd.pt')
# print('cnd:', cnd.shape, type(cnd))
